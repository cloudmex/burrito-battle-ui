...
export default class MainMenu extends Phaser.Scene{
    ...
    async createScene(){
        ...
        new Button(450, 550, 0.75, "buttonContainer", Translate.Translate("BtnGoMintBurrito"), this, ()=>{ this.ChangeScene("MinarBurrito")}, {fontSize: 60, fontFamily: "BangersRegular"});
        new Button(450, 700, 0.75, "buttonContainer", Translate.Translate("BtnMeadow"), this, ()=>{ this, this.ChangeScene("Pradera")}, {fontSize: 60, fontFamily: "BangersRegular"});
        new Button(450, 850, 0.75, "buttonContainer", Translate.Translate("BtnBarn"), this, ()=>{ this, this.ChangeScene("Establo")}, {fontSize: 60, fontFamily: "BangersRegular"});
        new Button(450, 1000, 0.75, "buttonContainer", Translate.Translate("HTP"), this, ()=>{ this, this.ChangeScene("HowToPlay")}, {fontSize: 60, fontFamily: "BangersRegular"});
