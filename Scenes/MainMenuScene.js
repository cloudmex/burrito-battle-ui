...
export class MainMenu extends Phaser.Scene{
    ...
    LogOut = () => {
        Helpers.Alert.Fire(this, this.game.config.width/2, this.game.config.heigdht/2, Translate.Translate("TleAccountAlert"), Translate.Translate("MsgAccountAlert"), Translate.Translate("BtnAccountAlert"), Translate.Translate("BtnCancelAlert"))
        .then((result) => {
            if(result) {
                localStorage.clear();
                Near.LogOut();
