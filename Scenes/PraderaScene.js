...
import { MinarBurrito } from "./MinarBurrito.js";
...
export class Pradera extends Phaser.Scene{
    ...
    async create(){
        ...
        if(localStorage.getItem("burrito_selected") == null){
            ...
            new Helpers.Button(800, 820, 0.4, "buttonContainer2", "Ir a Establo", this, () => {this.scene.start("Establo");}, null, {fontSize: 30, fontFamily: "BangersRegular"});
            new Helpers.Button(1130, 820, 0.4, "buttonContainer2", "Ir a Silo", this, () => {this.scene.start("MinarBurrito");}, null, {fontSize: 30, fontFamily: "BangersRegular"});
    ...
    async CreateScene(){
        ...
        this.physics.add.overlap(this.silo, this.burrito, () => {
            if(this.alertVisible == false){
                ...
                let button1 = new Helpers.Button(800, 820, 0.4, "buttonContainer2", "Entrar", this, () => {
        ...
        this.physics.add.overlap(this.coliseo, this.burrito, ()=>{ 
            ...
            if(this.alertVisible == false){
                let alert = new Helpers.Alert(960, 540, this, 0.8, "El colisio continua en construccion.\n\nEsta es una nueva mecanica que se esta \nimplementado actualmente.");
    ...
    Battle(burrito, triggerZone){
        ...
        /*Swal.fire({
          ...
          if(this.alertVisible == false){
            ...
            let button1 = new Helpers.Button(800, 820, 0.4, "buttonContainer2", "Pelear", this, () => {
                this.GoToBattle();
            }, null, {fontSize: 30, fontFamily: "BangersRegular"});
            let button2 = new Helpers.Button(1130, 820, 0.4, "buttonContainer2", "Huir", this, () => {
                alert.GetComponents().destroy();
                button1.GetComponents().destroy();
                button2.GetComponents().destroy();
                this.alertVisible = false;
