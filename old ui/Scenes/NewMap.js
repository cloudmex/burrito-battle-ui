...
export class NewMap extends Phaser.Scene{
    ...
    async loadAssets(){
        ...
        this.load.image("hospital", "./src/images/new Pradera/C12/hospital.png")
        ...
        this.load.spritesheet("coliseo_up_incursion", "./src/images/new Pradera/C10/coliseo_incursion.webp", {frameWidth:1920, frameHeight: 1080});
        this.load.image("coliseo_up_normal", "./src/images/new Pradera/C10/coliseo_normal.png");
        this.load.image("coliseo_up_reconstruccion", "./src/images/new Pradera/C10/coliseo_reconstruccion.png");
        this.load.image("coliseo_up_roto", "./src/images/new Pradera/C10/coliseo_roto.png");

        this.load.spritesheet("coliseo_down_incursion", "./src/images/new Pradera/C14/coliseo_incursion.webp", {frameWidth:1920, frameHeight: 1080});
        this.load.image("coliseo_down_normal", "./src/images/new Pradera/C14/coliseo_normal.png");
        this.load.image("coliseo_down_reconstruccion", "./src/images/new Pradera/C14/coliseo_reconstruccion.png");
        this.load.image("coliseo_down_roto", "./src/images/new Pradera/C14/coliseo_roto.png");
