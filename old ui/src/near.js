...
const contract_id_burritos = "dev-1662497209670-35450562637719"//"bb-burritos.testnet"//
...
const contract_id_hospital = "dev-1663091906107-11804226544868"//"bb-hospital.testnet"; 
...
const contract_hospital = new Contract(wallet.account(), contract_id_hospital, {
...
export async function CreateBattlePlayerCpu () {
    ...
    console.log(localStorage.getItem("burrito_selected"));
